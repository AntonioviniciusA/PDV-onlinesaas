  ...
  const faqs = [
    {
      ...
      answer:
        "Nosso teste gratuito de 7 dias oferece acesso completo a todos os recursos do plano selecionado. Nenhum cartão de crédito é necessário para se cadastrar, e você pode cancelar a qualquer momento durante o período de teste sem compromisso.",
    },
    {
