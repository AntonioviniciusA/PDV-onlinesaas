...
export function CashPaymentDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent
        className="max-w-md"
        aria-describedby="cash-payment-dialog-description"
      >
        <DialogDescription id="cash-payment-dialog-description">
          ...
          {isValidAmount && change > 0 && (
            <Alert className="border-orange-200 bg-orange-50">
              ...
              <AlertDescription className="text-orange-800">
                <strong>Atenção:</strong> Retornar R$ {change.toFixed(2)} de
                troco ao cliente
              </AlertDescription>
            </Alert>
          )}
