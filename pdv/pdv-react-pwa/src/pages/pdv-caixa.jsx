...
import CadastroProdutos from "./cadastro-produtos.jsx";
import EtiquetasPreco from "./etiquetas-preco";
import { Badge } from "../components/ui/badge.jsx";
import { useKeyboardShortcuts } from "../hooks/use-keyboard-shortcuts.js";
import { CashPaymentDialog } from "../components/cash-payment-dialog.jsx";
import { PixPaymentDialog } from "../components/pix-payment-dialog.jsx";
import { CardPaymentDialog } from "../components/card-payment-dialog.jsx";
import { MixedPaymentDialog } from "../components/mixed-payment-dialog.jsx";
import { WeightInputDialog } from "../components/weight-input-dialog.jsx";
import { ReceiptConfigDialog } from "../components/receipt-config-dialog.jsx";
import { CashManagementDialog } from "../components/cash-management-dialog.jsx";
...
export default function PDVCaixa() {
  ...
  const [receiptConfig, setReceiptConfig] = useState({
    ...
    defaultType: "fiscal",
    rolePermissions: {
      caixa: { canChoose: false, defaultType: "fiscal" },
      fiscal: { canChoose: true, defaultType: "fiscal" },
      supervisor: { canChoose: true, defaultType: "fiscal" },
      gerente: { canChoose: true, defaultType: "fiscal" },
      admin: { canChoose: true, defaultType: "fiscal" },
    },
  });
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden ">
      ...
      <div className="flex-1 overflow-auto flex flex-col bg-white">
        <div className="max-w-full m-2 justify-center h-full overflow-y-auto">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 h-full">
              ...
              <Card className="flex-1 flex flex-col min-h-0">
                ...
                <CardContent className="flex-1 flex flex-col min-h-0 relative">
                  ...
                  <div className="flex-1 flex items-center justify-center relative">
                    ...
                    {/* QR Code PIX - centralizado sobre a logo */}
                    {paymentMethod === "pix" && total > 0 && (
                      <div className="absolute inset-0 flex items-center justify-center z-10">
                        <div className="bg-white border-2 border-gray-300 rounded-lg shadow-lg p-6 max-w-80">
                          <h3 className="font-semibold mb-3 text-center text-sm text-gray-800">
                            QR Code PIX
                          </h3>
                          <div className="flex flex-col items-center space-y-2">
                            <div className="w-64 h-64 bg-white border border-gray-300 rounded-lg flex items-center justify-center">
                              <div className="text-center text-gray-500">
                                <p className="text-base">QR Code PIX</p>
            ...
            {/* Carrinho */}
            <div className="flex flex-col min-h-0 rounded-b-lg overflow-hidden">
              <Card className="flex-1 flex flex-col min-h-0 w-full bg-black text-white">
                ...
                <CardContent className="flex-1 flex flex-col min-h-0 space-y-3 bg-black text-white">
                  {/* Lista do Carrinho com Scroll */}
                  <div className="flex-1 min-h-0 bg-gray-100 text-black rounded-lg border-2 border-gray-500 p-2">
                            ...
                            >
                              ...
                              <div className="flex items-center gap-1">
                                <Button
                                  ...
                                  className="h-6 w-6 p-0 bg-white text-black border-gray-300 hover:bg-gray-100"
                                >
                  ...
                  <div className="flex flex-row gap-1">
                    <Button
                      variant="outline"
                      className="w-full h-8 text-xs bg-white text-black border-gray-300 hover:bg-gray-100"
                      onClick={openDiscount}
                      title="F7"
                    >
                      <Shield className="w-3 h-3 mr-1 text-yellow-500 fill-yellow-500" />
                      Desconto (F7)
                    </Button>
                  ...
                  {showPayment && paymentMethod && (
                    <div className="space-y-2 mt-2">
                      ...
                      <div className="grid grid-cols-3 gap-1">
                        <Button
                          variant={
                            paymentMethod === "dinheiro" ? "outline" : "default"
                          }
                        ...
                        <Button
                          variant={
                            paymentMethod === "cartao" ? "outline" : "default"
                          }
                        ...
                        <Button
                          variant={
                            paymentMethod === "pix" ? "outline" : "default"
                          }
                      ...
                      <Button
                        ...
                        className="w-full h-8 text-xs bg-white text-black border-gray-300 hover:bg-gray-100 mt-2"
                        title="F12"
                      >
      ...
      <RequestAuthorization
        ...
        title={authorizationRequest?.title || "Autorização Necessária"}
        description={
          authorizationRequest?.description ||
          "Informe ID e senha de autorização."
        }
        onSuccess={(user) => {
          if (authorizationRequest) {
