...
const DEFAULT_TEMPLATES: LabelTemplate[] = [
  ...
  },
  {
    ...
    colors: { background: "#f8fafc", text: "#1e293b", price: "#059669", comparison: "#1d4ed8" },
  },
]

export function LabelConfigDialog({ open, onOpenChange, currentTemplate, onSave }: LabelConfigDialogProps) {
  const [template, setTemplate] = useState<LabelTemplate>(currentTemplate)
  ...
  const loadPreset = (preset: LabelTemplate) => {
    setTemplate({ ...preset })
  ...
  const updateFontSize = (field: keyof LabelTemplate["fontSize"], value: number) => {
    setTemplate((prev) => ({
      ...prev,
  ...
  const updateColors = (field: keyof LabelTemplate["colors"], value: string) => {
    setTemplate((prev) => ({
      ...prev,
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-2">
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    onChange={(e) => updateTemplate({ showComparison: e.target.checked })}
                  />
                  <Label htmlFor="showComparison">Mostrar comparação de preços</Label>
                </div>
                <div className="flex items-center space-x-2">
                  <input
                    type="checkbox"
                    ...
                    onChange={(e) => updateTemplate({ showICMS: e.target.checked })}
                  />
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateFontSize("price", Number(e.target.value))}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateFontSize("comparison", Number(e.target.value))}
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) => updateFontSize("barcode", Number(e.target.value))}
                  />
                </div>
              </div>
            </div>
                ...
                <div>
                  ...
                  <div className="flex gap-2">
                    <Input
                      ...
                      onChange={(e) => updateColors("comparison", e.target.value)}
                      className="w-16 h-10 p-1"
                    />
                    <Input
                      value={template.colors.comparison}
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-center">
              ...
              >
                <div className="font-bold truncate mb-2" style={{ fontSize: `${template.fontSize.name}px` }}>
                  Coca-Cola 350ml
                </div>
                <div
                ...
                {template.showICMS && (
                  <div className="text-gray-500 mb-1" style={{ fontSize: `${template.fontSize.comparison}px` }}>
                    ICMS 18%
                  </div>
                )}
                {template.showBarcode && (
                  <div className="font-mono" style={{ fontSize: `${template.fontSize.barcode}px` }}>
                    7894900011517
                  </div>
                )}
              </div>
