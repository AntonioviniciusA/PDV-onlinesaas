...
export default function HistoricoVendas({ onBack }: HistoricoVendasProps) {
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-6 flex items-center gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600">Consulte e reimprima vendas anteriores</p>
          </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <p className="text-2xl font-bold text-purple-600">
                    R$ {totalTransactions > 0 ? (totalSales / totalTransactions).toFixed(2) : "0.00"}
                  </p>
                </div>
              </div>
            </CardContent>
                        ...
                        <Card key={sale.id} className="p-4">
                          <div className="flex items-center justify-between">
                            <div className="flex-1">
                              <div className="flex items-center gap-3 mb-2">
                                ...
                                <div className="flex items-center gap-1">
                                  ...
                                  <span className="text-sm text-gray-600">{getPaymentLabel(sale.paymentMethod)}</span>
                                </div>
                              </div>
                            ...
                            <div className="flex gap-2 ml-4">
                                    ...
                                    <div className="space-y-1 text-sm">
                                      ...
                                      {sale.discount > 0 && (
                                        <div className="flex justify-between text-red-600">
                                          ...
                                          <span>-R$ {((sale.subtotal * sale.discount) / 100).toFixed(2)}</span>
                                        </div>
                                      )}
                              ...
                              <Button size="sm" onClick={() => handlePrint(sale)}>
